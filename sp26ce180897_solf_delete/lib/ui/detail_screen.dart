// ============================================================
// 💾 HƯỚNG DẪN THÊM TRƯỜNG MỚI VÀO DETAIL SCREEN
// ============================================================
// KHI THÊM TRƯỜNG MỚI VÀO ARTWORK:
//
// Hiển thị trường mới trong detail:
//
// 1. Thêm widget hiển thị trường mới (trong phần Column)
//    Tìm vị trí hiển thị các trường hiện tại và thêm tương tự
//
// 2. Ví dụ thêm trường 'price':
//    - Thêm: _buildDetailRow('Price:', '\$${artwork.price?.toString() ?? 'N/A'}'),
//
...
class _DetailScreenState extends ConsumerState<DetailScreen> {
  ...
  // 🔐 SOFT DELETE: Gọi softDelete thay vì hard delete
  Future<void> _confirmDelete(BuildContext context, Artwork artwork) async {
    ...
    if (ok == true && artwork.id != null) {
      // 🔐 Gọi softDelete thay vì hard delete
      await DatabaseHelper.instance.softDeleteArtwork(artwork.id!);
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Artwork moved to trash')));
