...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    if (user != null) {
      ...
      saveSession(prefs, user.id!, user.username);
      if (mounted) {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Icon(Icons.home_rounded, size: 40, color: Color(0xFF2D9596)),
              ),
              ...
              TextButton(
                ...
                child: Text('No account? Register now', style: TextStyle(color: teal, fontWeight: FontWeight.w500)),
              ),
            ],
          ),
        ),
