...
class _TrashScreenState extends ConsumerState<TrashScreen> {
  ...
  // TODO [ADD]: Khai báo biến/trạng thái mới cho trường mới nếu cần
  // Ví dụ: String _selectedStatus = 'Active';
  // Ví dụ: bool _isFeatured = false;
  ...
  // TODO [ADD]: Thêm method xử lý trường mới cho TrashScreen nếu cần
  // Ví dụ: Future<void> _filterByStatus(String status) async { ... }
